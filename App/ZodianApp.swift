...
#if BETA
    /// One-time cache boundary after Beta moved from the immutable preview
    /// endpoint to the published Beta resolver. Scope is limited to the
    /// Daily Lens cache in this Beta app container.
    private func applyBetaDailyLensOverrideCacheRefreshIfNeeded() {
        let key = "zodian.betaDailyLensCacheRefresh.exactOverride.2026-07-31"
...
#if DEBUG
        modelTypes.append(EditorialReview.self)
#endif

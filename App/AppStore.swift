...
final class AppStore: ObservableObject {
    ...
    func dismissReturningDailyExperienceMessage() {
    ...
    private func presentDailyReadMomentumMomentIfNeeded(count: Int) {
        ...
        case 10:
            message = "Your saved Lenses are building a clearer record over time."
        default:
            return
        }
    ...
    func refreshNotificationScheduling() {
        let context = NotificationScheduleContext(
            ...
            westernSign: currentUser?.westernSign.displayName,
            easternSign: currentUser?.chineseSign.displayName
        )

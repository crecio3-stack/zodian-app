                ...
                GeometryReader { _ in
                    VStack(spacing: 0) {
                        OnboardingHeroHeader(
                            ...
                            subtitle: "Select the sign that matches your birthday.",
                            tone: .ritual,
                            isVisible: true,
                            shimmerActive: false,
...
private struct WesternZodiacWheelSelectorView: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel("Western astrology sign wheel")
        .accessibilityValue(selectedSign.displayName)
        .accessibilityHint("Swipe up or down to change your sign. Tap or spin the wheel to select.")

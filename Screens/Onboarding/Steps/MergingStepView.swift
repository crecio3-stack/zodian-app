                        ...
                        ScrollView(showsIndicators: false) {
                            VStack(spacing: 0) {
                                ...
                                OnboardingHeroHeader(
                                    eyebrow: "Convergence",
                                    title: "Your pattern is almost ready",
                                    subtitle: "Your Western and Eastern signs combine to create an identity that's uniquely yours.",
                                    tone: .ritual,
                                    isVisible: true,
                                    shimmerActive: false,
            ...
            Button(action: onToggle) {
                HStack(alignment: .center, spacing: 10) {
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        Text("Optional — refine your identity with your birth time and birthplace.")

...
enum NotificationService {
    ...
    static func refreshSchedules(using context: NotificationScheduleContext, now: Date = Date()) async {
        ...
        if context.dailyReminderEnabled {
            let badgeRequests = dailyReadyBadgeRequests(using: context, now: now)
    ...
    private static func dailyReadyBadgeRequests(using context: NotificationScheduleContext, now: Date) -> [UNNotificationRequest] {
    ...
    private static let notificationLibrary: [NotificationLine] = [
        NotificationLine(id: "call-out-01", category: "call-out", title: "You’re doing it again.", body: "Today’s Lens is ready. See what today’s horoscope brings into focus."),
        NotificationLine(id: "call-out-02", category: "call-out", title: "You almost missed this.", body: "Today’s Lens is ready. A new horoscope is waiting."),
        NotificationLine(id: "call-out-03", category: "call-out", title: "That thing you noticed?", body: "Today’s Lens is ready. Your horoscope may have something to say about it."),
        NotificationLine(id: "call-out-04", category: "call-out", title: "Do not pretend you missed it.", body: "Today’s Lens is ready. See what today’s horoscope brings up."),
        NotificationLine(id: "call-out-05", category: "call-out", title: "The day has a tell.", body: "Today’s Lens is ready. Your personalized horoscope is waiting."),
        NotificationLine(id: "call-out-06", category: "call-out", title: "You know this mood.", body: "Today’s Lens is ready. See what your horoscope makes of it."),

        NotificationLine(id: "curiosity-01", category: "curiosity", title: "Something feels different today.", body: "Today’s Lens is ready. Your horoscope is waiting."),
        NotificationLine(id: "curiosity-02", category: "curiosity", title: "There’s a twist in this one.", body: "Today’s Lens is ready. See what today’s horoscope brings into focus."),
        NotificationLine(id: "curiosity-03", category: "curiosity", title: "This day has an angle.", body: "Today’s Lens is ready. A new horoscope. A new perspective."),
        NotificationLine(id: "curiosity-04", category: "curiosity", title: "One detail may matter.", body: "Today’s Lens is ready. Your daily horoscope is ready to read."),
        NotificationLine(id: "curiosity-05", category: "curiosity", title: "The interesting part is small.", body: "Today’s Lens is ready. See what today’s horoscope catches."),
        NotificationLine(id: "curiosity-06", category: "curiosity", title: "Today has a little edge.", body: "Today’s Lens is ready. Your personalized horoscope has the read."),

        NotificationLine(id: "best-friend-01", category: "best-friend", title: "Okay, this one is very you.", body: "Today’s Lens is ready. Your horoscope is waiting."),
        NotificationLine(id: "best-friend-02", category: "best-friend", title: "I would read this.", body: "Today’s Lens is ready. See what today’s horoscope brings into focus."),
        NotificationLine(id: "best-friend-03", category: "best-friend", title: "This feels relevant.", body: "Today’s Lens is ready. A new horoscope is waiting."),
        NotificationLine(id: "best-friend-04", category: "best-friend", title: "You may want to see this.", body: "Today’s Lens is ready. Your personalized horoscope is here."),
        NotificationLine(id: "best-friend-05", category: "best-friend", title: "This one has your name on it.", body: "Today’s Lens is ready. See what your horoscope says about today."),
        NotificationLine(id: "best-friend-06", category: "best-friend", title: "Not to be dramatic, but read it.", body: "Today’s Lens is ready. Your horoscope is waiting."),

        NotificationLine(id: "lens-bridge-01", category: "lens-bridge", title: "Today’s Lens is ready.", body: "Your personalized daily horoscope is waiting."),
        NotificationLine(id: "lens-bridge-02", category: "lens-bridge", title: "Your horoscope is ready.", body: "Today’s Lens brings the day into focus."),
        NotificationLine(id: "lens-bridge-03", category: "lens-bridge", title: "A new Lens just opened.", body: "Your personalized daily horoscope is ready."),
        NotificationLine(id: "lens-bridge-04", category: "lens-bridge", title: "Today has a read.", body: "Today’s Lens is ready. See what your horoscope brings up."),
        NotificationLine(id: "lens-bridge-05", category: "lens-bridge", title: "Your daily horoscope is here.", body: "Today’s Lens is ready when you are."),
        NotificationLine(id: "lens-bridge-06", category: "lens-bridge", title: "A new day, a new Lens.", body: "Your personalized horoscope is ready.")
    ]
}

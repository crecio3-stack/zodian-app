...
extension SavedDailyReading {
    convenience init(
        ...
        self.init(
            ...
            // New records preserve the title/read presentation payload. Required
            // legacy columns stay blank rather than manufacturing six-field meaning.
            theme: "",
            summary: "",
    ...
    var versionedLensContent: DailyLensContent? {
        guard let read = canonicalRead,
              read.isNonblankForSavedLens else {
            return nil
        }
...
private extension String {
    var isNonblankForSavedLens: Bool {

...
extension ZodiacIdentityContent {
    static func fromArchetype(
        ...
        ZodiacIdentityContent(
            ...
            shadowPattern: archetype.growthPath,
            bestPractices: [archetype.growthPath],
            earlyExpression: archetype.hiddenInsight ?? archetype.overview,
            matureExpression: archetype.overview,
            shadowLoop: archetype.growthPath,
            ritualPrompt: archetype.hiddenInsight ?? archetype.growthPath,
            mantra: archetype.growthPath
        )
    }
}
